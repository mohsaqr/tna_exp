...
[`tna()`](https://sonsoles.me/tna/reference/build_model.md) function .
...
can be used to compute various centrality measures (see
[`?centralities`](https://sonsoles.me/tna/reference/centralities.md) for
